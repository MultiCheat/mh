...
function imgui.OnDrawFrame()
  if main_window_state.v then
    ...
    if imgui.Button('GAY!') then
      printStringNow('YES!', 1000)
      update()
    end
...
function update()
  ...
  downloadUrlToFile('https://raw.githubusercontent.com/MultiCheat/mh/main/update.json', fpath, function(id, status, p1, p2) -- ссылку на ваш гитхаб где есть строчки которые я ввёл в теме или любой другой сайт
